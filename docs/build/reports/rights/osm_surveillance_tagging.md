# Rights-review packet — `osm_surveillance_tagging` (OSM surveillance tagging (Tag:man_made=surveillance))
...
- **Source id:** `osm_surveillance_tagging`
- **Homepage:** https://wiki.openstreetmap.org/wiki/Tag:man_made%3Dsurveillance
