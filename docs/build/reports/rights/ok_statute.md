# Rights-review packet — `ok_statute` (Oklahoma statutes (47 O.S. §7-606.1 et seq.))
...
- **Source id:** `ok_statute`
- **Homepage:** https://www.oscn.net/applications/oscn/index.asp?ftdb=STOKST47
- **Terms URL(s):** https://www.oscn.net/
...
> export gate closed). R1 statutory / legal regime. Oklahoma statutory text (OSCN). Statutes/edicts of government are not copyrightable in the U.S. (public domain); OSCN's site terms govern access method only.
>
