# Rights-review packet — `ccops_seattle` (SIG-LIC-001, P24.7 / CCOPS.1)
...
- **Source id:** `ccops_seattle`
- **Class:** `government_mandated_disclosure` (SIG-INGEST-049) — municipal records statutorily
  published under the Seattle Surveillance Ordinance (SMC 14.18).
- **Homepage:** https://www.seattle.gov/tech/data-privacy/surveillance-technology
...
> Not fetched this pass. The disclosures are documents the City of Seattle is *required by
> ordinance* to publish (Surveillance Impact Reports, the Master List, quarterly CTO
> acquisition-determination reports). Municipal records posted for public access are not thereby
> dedicated to the public domain — municipal copyright posture is **not resolved** in this packet;
> per-document terms are recorded per fixture.
...
extracted facts (dates, statuses, counts) are un-copyrightable facts in US practice, but the
