# Rights-review packet — `amsterdam_camerakaart` (Amsterdam cameraregister — municipal camera map open data)
...
- **Source id:** `amsterdam_camerakaart`
...
A municipal camera register published as open data on the France-RAA pattern.
