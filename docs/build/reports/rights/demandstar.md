# Rights-review packet — `demandstar` (DemandStar — public agency bid portal)
...
> The host was reached on 2026-09-16 (host reached (308)); no source *content* was fetched.

- **Source id:** `demandstar`
- **Homepage:** https://www.demandstar.com/
...
A public-agency bid portal (records/procurement surface).
