# Rights-review packet — `planetbids` (PlanetBids — public agency procurement portals)
...
- **Source id:** `planetbids`
- **Homepage:** https://www.planetbids.com/
...
A per-agency procurement portal platform (records/procurement surface).
