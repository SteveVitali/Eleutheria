# Rights-review packet — `okcpd_policy` (OKCPD — policy (Operations Manual))
...
- **Source id:** `okcpd_policy`
- **Homepage:** https://www.okc.gov/departments/police
- **Terms URL(s):** https://www.okc.gov/
...
> export gate closed). R2 agency policy. OKCPD Operations Manual §5-118 (ALPR policy) — agency policy document, government public record.
>
