# Rights-review packet — `powerdms_public_portals` (PowerDMS public policy portals)
...
> The host was reached on 2026-09-16 (host reached (302)); no source *content* was fetched.

- **Source id:** `powerdms_public_portals`
- **Homepage:** https://powerdms.com/
...
Per-agency public policy portals — a records surface on the okcpd_policy pattern.
