# Rights-review packet — `pathways_acoustic_drone_location` (SIG-LIC-001, P21.1/P21.9)
...
- **Source id:** `pathways_acoustic_drone_location`
...
> Not fetched this pass. This source is the P17.3 acoustic/drone/location pathway family (gunshot-detection deployment reports, drone/UAS purchase orders, and commercial location-data subscription disclosures). The underlying documents are public transparency reports, procurement records, and vendor disclosures; their individual terms are per-document and recorded per fixture.
