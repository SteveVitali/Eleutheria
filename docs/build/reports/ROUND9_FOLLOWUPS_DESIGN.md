...
| 148 | P31.7 `claim-re-sightings` | DEEPEN.3 | link re-asserted claims to the new capture; decide the dating basis + storage budget | D-P30.2a-2 | storage budget (Q5) | M | **R9-RESIGHT** |
...
| 158 | P31.17 `human-review-campaign` | HUMAN-H4 | curators adjudicate a stratified sample of camera-site proposals through P31.10 | (precondition of D-R6.1-EVAL) | **human** | — | — |
| 159 | P31.18 `resolution-eval-from-first-principles` | EVAL.1 | **skeleton**: rules v3 + human holdout + re-derived auto-vs-human balance | D-R6.1-EVAL, D-P30.2b-2, D-P30.2b-1 | after P31.17 | (L) | **R9-EVAL** |
