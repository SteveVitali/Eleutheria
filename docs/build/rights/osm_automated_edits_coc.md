# Rights-review packet — `osm_automated_edits_coc` (OSM Automated Edits code of conduct)
...
- **Source id:** `osm_automated_edits_coc`
- **Homepage:** https://wiki.openstreetmap.org/wiki/Automated_Edits_code_of_conduct
