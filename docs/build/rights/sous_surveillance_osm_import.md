# Rights-review packet — `sous_surveillance_osm_import` (sous-surveillance.net → OSM import)
...
- **Source id:** `sous_surveillance_osm_import`
- **Homepage:** https://wiki.openstreetmap.org/wiki/Import/sous-surveillance
