# Rights-review packet — `pathways_rtcc_federation` (SIG-LIC-001, P21.1/P21.9)
...
- **Source id:** `pathways_rtcc_federation`
...
> Not fetched this pass. This source is the P17.1 federation/RTCC pathway family (municipal
> RTCC integration disclosures, private-camera registries, and the commercial data-broker
> chain). The underlying documents are public procurement records, vendor press releases, and
> advocacy analyses; their individual terms are per-document and recorded per fixture.
