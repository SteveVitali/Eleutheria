# Rights-review packet — `osm_element_history` (OSM element history)
...
- **Source id:** `osm_element_history`
- **Homepage:** https://api.openstreetmap.org/api/0.6/node/<id>/history.json
