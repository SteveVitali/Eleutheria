<!--
  Tail marker GATE-ACCEPT. Filled by decompose-spec mode=extend over docs/3_sig_golive_spec.md
...
back to closure. The go-live round (Rounds 3–4 against `docs/3_sig_golive_spec.md`) is not
