...
> **Host pre-answered — GL-GATE-04 (HG-12).** GCP project `$SIG_GCP_PROJECT` (name
...
- [ ] Real host target on GCP `$SIG_GCP_PROJECT` + Secret Manager — `provided: no`. <!-- HG-12 / GL-GATE-04 -->
- [ ] `SIG_GCP_PROJECT` exported in the run shell / Secret Manager — `provided: no`. <!-- HG-12 / GL-GATE-04 / D3 -->
