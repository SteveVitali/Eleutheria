...
URI: [sig:IntegrationEdge](https://ontology.sig-project.org/schema/IntegrationEdge)
 ...
 classDiagram
    ...
    click IntegrationEdge href "../IntegrationEdge/"
      ...
      IntegrationEdge : applies_to_cohort
        ...
        click CohortApplicability href "../CohortApplicability/"
...
| ---  | --- | --- | --- |
| [data_kind](data_kind.md) | 1 <br/> [String](String.md) | The kind of data that moves (part of the edge key, SIG-ONTO-046) | direct |
| [initiator](initiator.md) | 0..1 <br/> [Uriorcurie](Uriorcurie.md) |  | direct |
| [transport](transport.md) | 0..1 <br/> [String](String.md) |  | direct |
| [granularity](granularity.md) | 0..1 <br/> [String](String.md) |  | direct |
| [data_comes_to_rest](data_comes_to_rest.md) | 0..1 <br/> [Boolean](Boolean.md) |  | direct |
| [scope](scope.md) | 0..1 <br/> [CapabilityScope](CapabilityScope.md) |  | direct |
| [consent_gate](consent_gate.md) | 0..1 <br/> [Boolean](Boolean.md) |  | direct |
| [mechanism](mechanism.md) | 0..1 <br/> [String](String.md) |  | direct |
| [terminable_by](terminable_by.md) | 0..1 <br/> [Uriorcurie](Uriorcurie.md) |  | direct |
| [termination_reason](termination_reason.md) | 0..1 <br/> [String](String.md) |  | direct |
| [applies_to_cohort](applies_to_cohort.md) | 0..1 <br/> [CohortApplicability](CohortApplicability.md) | Partial termination cohort — all / new_customers_only / existing_customers_on... | direct |
