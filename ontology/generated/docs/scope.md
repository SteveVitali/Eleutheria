...
URI: [sig:scope](https://ontology.sig-project.org/schema/scope)
...
| Domain Of | [Capability](Capability.md), [AccessRelationship](AccessRelationship.md), [IntegrationEdge](IntegrationEdge.md) |
