...
URI: [sig:audit_source_type](https://ontology.sig-project.org/schema/audit_source_type)
...
| Property | Value |
| --- | --- |
| Range | [AuditSourceType](AuditSourceType.md) |
...
| ---  | ---  |
| self | sig:audit_source_type |
| native | sig:audit_source_type |
