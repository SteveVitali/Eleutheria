...
URI: [sig:national_lookup_enabled](https://ontology.sig-project.org/schema/national_lookup_enabled)
...
| ---  | ---  |
| self | sig:national_lookup_enabled |
| native | sig:national_lookup_enabled |
