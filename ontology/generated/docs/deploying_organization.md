...
URI: [sig:deploying_organization](https://ontology.sig-project.org/schema/deploying_organization)
...
| ---  | ---  |
| self | sig:deploying_organization |
| native | sig:deploying_organization |
