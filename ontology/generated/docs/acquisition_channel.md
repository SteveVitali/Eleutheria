...
URI: [sig:acquisition_channel](https://ontology.sig-project.org/schema/acquisition_channel)
...
| Property | Value |
| --- | --- |
| Range | [AcquisitionChannel](AcquisitionChannel.md) |
...
| ---  | ---  |
| self | sig:acquisition_channel |
| native | sig:acquisition_channel |
