...
_Whether valid_to is known, unknown, or ongoing (§9.5, SIG-ONTO-044)._
...
URI: [sig:valid_to_kind](https://ontology.sig-project.org/schema/valid_to_kind)
...
| Property | Value |
| --- | --- |
| Range | [TemporalBoundKind](TemporalBoundKind.md) |
...
| ---  | ---  |
| self | sig:valid_to_kind |
| native | sig:valid_to_kind |
...
```yaml
name: valid_to_kind
description: Whether valid_to is known, unknown, or ongoing (§9.5, SIG-ONTO-044).
