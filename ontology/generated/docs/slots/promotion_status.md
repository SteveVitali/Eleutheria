...
URI: [sig:slot/promotion_status](https://ontology.sig-project.org/schema/slot/promotion_status)
...
| Property | Value |
| --- | --- |
| Range | [PromotionStatus](../enums/PromotionStatus.md) |
...
| ---  | ---  |
| self | sig:promotion_status |
| native | sig:promotion_status |
