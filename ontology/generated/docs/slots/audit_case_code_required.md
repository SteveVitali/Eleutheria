...
URI: [sig:slot/audit_case_code_required](https://ontology.sig-project.org/schema/slot/audit_case_code_required)
...
| ---  | ---  |
| self | sig:audit_case_code_required |
| native | sig:audit_case_code_required |
