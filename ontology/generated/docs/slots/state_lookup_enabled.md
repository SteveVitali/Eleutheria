...
URI: [sig:slot/state_lookup_enabled](https://ontology.sig-project.org/schema/slot/state_lookup_enabled)
...
| ---  | ---  |
| self | sig:state_lookup_enabled |
| native | sig:state_lookup_enabled |
